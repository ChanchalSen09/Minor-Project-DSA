...
Board.prototype.toggleTutorialButtons = function () {
  ...
  function nextPreviousClick() {
    if (counter === 1) {
      ...
      document.getElementById(
        "tutorial"
      ).innerHTML = `<p>My name is Chanchal Sen, a third-year B.Tech (CSE) student at Jawaharlal Institute of Technology, specializing in C++ and Data Structures. Currently, I'm focusing on web development using the MERN stack. Outside of academics, I enjoy music, gaming, and investing. I prioritize effective communication and collaboration in my work.</p>
        <h3>Enjoy!</h3>
        <h6>I hope you find as much joy exploring this visualization tool as I did creating it!</h6>
        <p>If you're curious about the source code for this application, feel free to visit my <a href="https://github.com/clementmihailescu/Pathfinding-Visualizer">GitHub</a>.</p><div id="tutorialCounter">${counter}/9</div><button id="finishButton" class="btn btn-default navbar-btn" type="button">Finish</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`;
